...
fun calculateEMI(principal: Double, rate: Double, tenure: Double): Double {
...
fun calculateInterestRate(principal: Double, emi: Double, tenure: Double): Double {
    var rate = 0.0
    var high = 100.0
    var low = 0.0
...
fun calculateAmortizationSchedule(principal: Double, rate: Double, tenure: Int): List<Pair<Double, Double>> {
    val emi = calculateEMI(principal, rate, tenure)
    val monthlyRate = rate / (12 * 100)
    var remainingPrincipal = principal
    val schedule = mutableListOf<Pair<Double, Double>>()
    ...
    for (month in 1..tenure) {
        ...
        schedule.add(Pair(principalComponent, interestComponent))
    }
...
fun main() {
    ...
    val tenure = 12.0 // tenure in months
